...
def corner(
    ...
    ax[1,0].set_title(f'{team_home} - {team_away} Corner Kick' )
    ...
    ax[1,1].set_title(f'{team_home} - {team_away} First Half Corner Kick' )
    ...
    ax[1,2].set_title(f'{team_home} - {team_away} Second Half Corner Kick' )
    ...
    ax1.set_title(f'{team_home} Son 20 Home Maci Korner Kick')
    ...
    ax2.set_title(f'{team_home} Son 20 Ev Maci Korner Kick First Half')
    ...
    ax3.set_title(f'{team_home} Son 20 Home Maci Korner Kick Second Half')
    ...
    ax4.set_title(f'{team_away} Son 20 Dep Maci Korner Kick')
    ...
    ax5.set_title(f'{team_away} Son 20 Dep Maci Korner Kick First Half')
    ...
    #------ax6------  EV SON 20 KORNER SECOND HALF ------------
    ...
    ax6.set_title(f'{team_away} Son 20 Dep Maci Korner Kick Second Half')
